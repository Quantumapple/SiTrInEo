...
class MimosaSimuDetectorConstruction : public G4VUserDetectorConstruction {
  ...
  public:
    ...
    void SetRotationMatrix(G4double RotationX, G4double RotationY, G4double RotationZ,
  ...
  private:
    ...
    G4LogicalVolume *
        *fLogicMimosaSensor; // pointer to the logical  Mimosa Sensor (epitaxial layer => sensitive)
    G4VPhysicalVolume **
        fPhysicMimosaSensor; // pointer to the physical Mimosa Sensor (epitaxial layer => sensitive)

    G4LogicalVolume *
        *fLogicMimosaSensorMetal; // pointer to the logical  Mimosa metal layer => non-sensitive
    G4VPhysicalVolume *
        *fPhysicMimosaSensorMetal; // pointer to the physical Mimosa metal layer => non-sensitive

    G4LogicalVolume **fLogicMimosaSensorSubstrate; // pointer to the logical  Mimosa substrate layer
                                                   // => non-sensitive
    G4VPhysicalVolume **fPhysicMimosaSensorSubstrate; // pointer to the physical Mimosa substrate
                                                      // layer => non-sensitive
    ...
    G4LogicalVolume *fMagneticRegionLogical;
    ...
    static G4ThreadLocal G4FieldManager *fMyMagneticFieldManager;
    static G4ThreadLocal MimosaSimuMagneticField *fMyMagneticField;
